...
' Add to console
TxtConsole.Text = TxtConsole.Text & UserList(Index).Name & " Has Dis-Connected!"
...
Call SendToAll(Rdata, Index) ' Send To Everyone

' Add text to console
TxtConsole.Text = TxtConsole.Text & vbNewLine & UserList(Index).Name & ": " & Rdata
'Fix Console height
TxtConsole.SelLength = TxtConsole.Height
